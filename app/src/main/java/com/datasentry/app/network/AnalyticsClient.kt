...
class AnalyticsClient(private val context: Context) {
    ...
    companion object {
        ...
        private const val SERVER_URL = "https://thomasine-hyperdulic-gilda.ngrok-free.dev/api/dns-data"
    ...
    private fun sendBatch() {
        ...
        val dnsQueries = batchToSend.map { packet ->
            DnsQuery(
                ...
                domain = extractDomainFromIp(packet.destIp),
    ...
    private fun extractDomainFromIp(ip: String): String {
        // This is a simplified version - you'd enhance this with actual DNS resolution
        return when {
            ip.startsWith("172.217.") -> "googlevideo.com"
            ip.startsWith("142.250.") -> "google.com"
            ip.startsWith("104.16.") -> "cloudflare.com"
            ip.startsWith("52.") -> "aws.amazon.com"
            else -> "unknown.domain"
        }
    }
