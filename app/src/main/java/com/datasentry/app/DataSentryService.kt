...
class DataSentryService : VpnService() {
    ...
    // Analytics client for server communication
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        analyticsClient = AnalyticsClient(this)
        ...
        try {
            ...
            if (REAL_MODE) {
                ...
                vpnInterface?.let { pfd ->
                    ...
                    dnsHandler?.start()
                    // Start periodic sending to server
                    analyticsClient.startPeriodicSending()
