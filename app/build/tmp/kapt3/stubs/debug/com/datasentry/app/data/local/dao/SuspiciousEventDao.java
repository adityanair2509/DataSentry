...
public abstract interface SuspiciousEventDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM suspicious_events WHERE packageName = :packageName ORDER BY timestamp DESC")
    @org.jetbrains.annotations.NotNull()
    ...
    @androidx.room.Query(value = "SELECT * FROM suspicious_events WHERE riskLevel = :riskLevel ORDER BY timestamp DESC")
    @org.jetbrains.annotations.NotNull()
    ...
    @androidx.room.Query(value = "SELECT * FROM suspicious_events WHERE trafficType = :trafficType ORDER BY timestamp DESC")
    @org.jetbrains.annotations.Nullable()
    ...
    @androidx.room.Query(value = "SELECT * FROM suspicious_events WHERE timestamp >= :startTime AND timestamp <= :endTime ORDER BY timestamp DESC")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getByTimeRange(long startTime, long endTime, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.util.List<com.datasentry.app.data.model.SuspiciousEvent>> $completion);
    
    @androidx.room.Query(value = "SELECT COUNT(*) FROM suspicious_events")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getCount(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.lang.Integer> $completion);
    
    @androidx.room.Query(value = "SELECT COUNT(*) FROM suspicious_events WHERE riskLevel = :riskLevel")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getCountByRiskLevel(@org.jetbrains.annotations.NotNull()
    com.datasentry.app.data.model.RiskLevel riskLevel, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.lang.Integer> $completion);
    
    @androidx.room.Query(value = "SELECT * FROM suspicious_events ORDER BY timestamp DESC LIMIT 1")
    @org.jetbrains.annotations.Nullable()
    ...
    @androidx.room.Query(value = "SELECT * FROM suspicious_events ORDER BY timestamp DESC LIMIT :limit")
    @org.jetbrains.annotations.Nullable()
    ...
    @androidx.room.Query(value = "DELETE FROM suspicious_events")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object deleteAll(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion);
    
    @androidx.room.Query(value = "DELETE FROM suspicious_events WHERE packageName = :packageName")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object deleteByPackage(@org.jetbrains.annotations.NotNull()
    java.lang.String packageName, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion);
    
    @androidx.room.Query(value = "DELETE FROM suspicious_events WHERE timestamp < :timestamp")
    @org.jetbrains.annotations.Nullable()
