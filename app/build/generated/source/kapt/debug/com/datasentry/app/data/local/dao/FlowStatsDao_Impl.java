...
public final class FlowStatsDao_Impl implements FlowStatsDao {
  ...
  @Override
  public Object insert(final FlowStats flowStats, final Continuation<? super Long> arg1) {
  ...
  @Override
  public Object update(final FlowStats flowStats, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object deleteByPackage(final String packageName, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object upsert(final FlowStats flowStats, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object getAll(final Continuation<? super List<FlowStats>> arg0) {
    final String _sql = "SELECT * FROM flow_stats ORDER BY lastSeen DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  public Object getByPackage(final String packageName,
      final Continuation<? super List<FlowStats>> arg1) {
    final String _sql = "SELECT * FROM flow_stats WHERE packageName = ? ORDER BY lastSeen DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (packageName == null) {
  ...
  public Object getByTimeRange(final long startTime, final long endTime,
      final Continuation<? super List<FlowStats>> arg2) {
  ...
  @Override
  public Object getTotalDataUsage(final Continuation<? super Long> arg0) {
  ...
  @Override
  public Object getDataUsageByTrafficType(final Continuation<? super List<TrafficTypeUsage>> arg0) {
  ...
  @Override
  public Object getDataUsageByApp(final Continuation<? super List<AppDataUsage>> arg0) {
  ...
  @Override
  public Object getMostRecentFlows(final Continuation<? super List<FlowStats>> arg0) {
