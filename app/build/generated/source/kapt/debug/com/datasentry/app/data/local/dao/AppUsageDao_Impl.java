...
public final class AppUsageDao_Impl implements AppUsageDao {
  ...
  @Override
  public Object insert(final AppUsage appUsage, final Continuation<? super Long> arg1) {
  ...
  @Override
  public Object update(final AppUsage appUsage, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object getAll(final Continuation<? super List<AppUsage>> arg0) {
    final String _sql = "SELECT * FROM app_usage ORDER BY startTime DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  public Object getByPackage(final String packageName,
      final Continuation<? super List<AppUsage>> arg1) {
    final String _sql = "SELECT * FROM app_usage WHERE packageName = ? ORDER BY startTime DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (packageName == null) {
  ...
  public Object getByTimeRange(final long startTime, final long endTime,
      final Continuation<? super List<AppUsage>> arg2) {
  ...
  @Override
  public Object getUniquePackages(final Continuation<? super List<String>> arg0) {
  ...
  @Override
  public Object getUniquePackageCount(final Continuation<? super Integer> arg0) {
