  ...
  public PacketDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPacketEntity = new EntityInsertionAdapter<PacketEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `packets` (`id`,`timestamp`,`sourceIp`,`destIp`,`protocol`,`sizeBytes`,`appName`,`packageName`,`contentType`,`isRisk`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getContentType() == null) {
          ...
          statement.bindString(9, entity.getContentType());
        }
      ...
      public List<PacketEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsRisk = _tmp != 0;
            _item = new PacketEntity(_tmpId,_tmpTimestamp,_tmpSourceIp,_tmpDestIp,_tmpProtocol,_tmpSizeBytes,_tmpAppName,_tmpPackageName,_tmpContentType,_tmpIsRisk);
            _result.add(_item);
          }
          return _result;
        } finally {
