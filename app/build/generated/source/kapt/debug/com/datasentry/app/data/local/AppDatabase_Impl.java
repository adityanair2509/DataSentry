  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `packets` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `timestamp` INTEGER NOT NULL, `sourceIp` TEXT NOT NULL, `destIp` TEXT NOT NULL, `protocol` TEXT NOT NULL, `sizeBytes` INTEGER NOT NULL, `appName` TEXT NOT NULL, `contentType` TEXT NOT NULL, `isRisk` INTEGER NOT NULL, `riskScore` INTEGER NOT NULL, `analysisEngine` TEXT NOT NULL, `analysisTimestamp` INTEGER NOT NULL, `deviceId` TEXT NOT NULL)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '1e9aeab5b3653eede95f9f5323829762')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsPackets = new HashMap<String, TableInfo.Column>(13);
        ...
        _columnsPackets.put("riskScore", new TableInfo.Column("riskScore", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPackets.put("analysisEngine", new TableInfo.Column("analysisEngine", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPackets.put("analysisTimestamp", new TableInfo.Column("analysisTimestamp", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPackets.put("deviceId", new TableInfo.Column("deviceId", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "1e9aeab5b3653eede95f9f5323829762", "44c7334591d1c329f1671f86518ddc0d");
