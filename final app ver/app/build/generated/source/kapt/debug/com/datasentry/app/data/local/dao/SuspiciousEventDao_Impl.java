...
public final class SuspiciousEventDao_Impl implements SuspiciousEventDao {
  ...
  @Override
  public Object insert(final SuspiciousEvent event, final Continuation<? super Long> arg1) {
  ...
  @Override
  public Object update(final SuspiciousEvent event, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object getAll(final Continuation<? super List<SuspiciousEvent>> arg0) {
    final String _sql = "SELECT * FROM suspicious_events ORDER BY timestamp DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  public Object getByPackage(final String packageName,
      final Continuation<? super List<SuspiciousEvent>> arg1) {
    final String _sql = "SELECT * FROM suspicious_events WHERE packageName = ? ORDER BY timestamp DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (packageName == null) {
  ...
  public Object getByTimeRange(final long startTime, final long endTime,
      final Continuation<? super List<SuspiciousEvent>> arg2) {
  ...
  @Override
  public Object getLatest(final Continuation<? super SuspiciousEvent> arg0) {
  ...
  @Override
  public Object getRecent(final int limit, final Continuation<? super List<SuspiciousEvent>> arg1) {
